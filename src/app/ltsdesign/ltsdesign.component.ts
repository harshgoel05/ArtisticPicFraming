...
export class LtsdesignComponent implements OnInit {
  design_array = [
    { image: "", name: "Frame1", price: 100 },
    { image: "", name: "Frame2", price: 200 },
    { image: "", name: "Frame3", price: 300 },
  ];
  quantity;
  added;
  errormessage;
  ...
  _addtocart(i) {
    let _design_details = {
      ...
      item: {
        image: this.design_array[i].image,
        name: this.design_array[i].name,
        price: this.design_array[i].price,
        quantity: this.quantity[i],
      },
    };
    this.back.addtocart(_design_details).subscribe(
      (res) => {
